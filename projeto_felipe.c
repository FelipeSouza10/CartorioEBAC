...
int registro() // função responsavel para cadastra usuários no sistema
{
	...
	char arquivo[40];
		char cpf[40];
			char nome[40];
				...
				printf("digite um CPF a ser cadastrado: "); //coletando informações do usuário
				scanf("%s", cpf); // %s refere-se a string
				
	strcpy (arquivo, cpf); // responsável por copiar o valor das string
	
	FILE *file; // cria o arquivo
	file = fopen(arquivo, "w"); //criar o arquivo função "w" significa escrever
